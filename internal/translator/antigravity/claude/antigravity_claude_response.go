			...
			if partTextResult.Exists() {
				...
				if partResult.Get("thought").Bool() {
					if thoughtSignature := partResult.Get("thoughtSignature"); thoughtSignature.Exists() && thoughtSignature.String() != "" {
						...
						output = output + "event: content_block_delta\n"
						data, _ := sjson.Set("{\"type\":\"content_block_delta\",\"index\":"+strconv.Itoa(int(params.ResponseIndex))+",\"delta\":{\"type\":\"thinking_delta\",\"thinking\":\"\"}}", "delta.thinking", partTextResult.String())
						output = output + "data: " + data + "\n\n\n"
						params.HasContent = true
					} else {
						...
						if params.ResponseType != 0 {
							...
							output = output + "data: {\"type\":\"content_block_stop\",\"index\":" + strconv.Itoa(int(params.ResponseIndex)) + "}"
							output = output + "\n\n\n"
						...
						output = output + "data: {\"type\":\"content_block_start\",\"index\":" + strconv.Itoa(int(params.ResponseIndex)) + ",\"content_block\":{\"type\":\"thinking\",\"thinking\":\"\"}}"
						output = output + "\n\n\n"
						output = output + "event: content_block_delta\n"
						data, _ := sjson.Set("{\"type\":\"content_block_delta\",\"index\":"+strconv.Itoa(int(params.ResponseIndex))+",\"delta\":{\"type\":\"thinking_delta\",\"thinking\":\"\"}}", "delta.thinking", partTextResult.String())
						output = output + "data: " + data + "\n\n\n"
					...
					if partTextResult.String() != "" || !finishReasonResult.Exists() {
						...
						if params.ResponseType == 1 {
							output = output + "event: content_block_delta\n"
							data, _ := sjson.Set("{\"type\":\"content_block_delta\",\"index\":"+strconv.Itoa(int(params.ResponseIndex))+",\"delta\":{\"type\":\"text_delta\",\"text\":\"\"}}", "delta.text", partTextResult.String())
							output = output + "data: " + data + "\n\n\n"
							params.HasContent = true
						} else {
							...
							if partTextResult.String() != "" {
								...
								output = output + "event: content_block_start\n"
								output = output + "data: {\"type\":\"content_block_start\",\"index\":" + strconv.Itoa(int(params.ResponseIndex)) + ",\"content_block\":{\"type\":\"text\",\"text\":\"\"}}"
								output = output + "\n\n\n"
								output = output + "event: content_block_delta\n"
								data, _ := sjson.Set("{\"type\":\"content_block_delta\",\"index\":"+strconv.Itoa(int(params.ResponseIndex))+",\"delta\":{\"type\":\"text_delta\",\"text\":\"\"}}", "delta.text", partTextResult.String())
								output = output + "data: " + data + "\n\n\n"
				...
				data := "{\"type\":\"content_block_start\",\"index\":" + strconv.Itoa(int(params.ResponseIndex)) + ",\"content_block\":{\"type\":\"tool_use\",\"id\":\"\",\"name\":\"\",\"input\":{}}}"
				...
				if fcArgsResult := functionCallResult.Get("args"); fcArgsResult.Exists() {
					output = output + "event: content_block_delta\n"
					data, _ = sjson.Set("{\"type\":\"content_block_delta\",\"index\":"+strconv.Itoa(int(params.ResponseIndex))+",\"delta\":{\"type\":\"input_json_delta\",\"partial_json\":\"\"}}", "delta.partial_json", fcArgsResult.Raw)
					output = output + "data: " + data + "\n\n\n"
				}

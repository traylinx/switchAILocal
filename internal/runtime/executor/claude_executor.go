...
func (e *ClaudeExecutor) PrepareRequest(_ *http.Request, _ *switchailocalauth.Auth) error { return nil }
...
func (e *ClaudeExecutor) CountTokens(ctx context.Context, auth *switchailocalauth.Auth, req switchailocalexecutor.Request, opts switchailocalexecutor.Options) (switchailocalexecutor.Response, error) {
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		return switchailocalexecutor.Response{}, statusErr{code: resp.StatusCode, msg: string(b)}
	}
...
func (e *ClaudeExecutor) resolveUpstreamModel(alias string, auth *switchailocalauth.Auth) string {
...
func (e *ClaudeExecutor) resolveClaudeConfig(auth *switchailocalauth.Auth) *config.ClaudeKey {
...
func applyClaudeHeaders(r *http.Request, auth *switchailocalauth.Auth, apiKey string, stream bool, extraBetas []string) {
...
func claudeCreds(a *switchailocalauth.Auth) (apiKey, baseURL string) {
	if a == nil {
		return "", ""
	}
	if a.Attributes != nil {

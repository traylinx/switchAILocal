...
func (e *CodexExecutor) PrepareRequest(_ *http.Request, _ *switchailocalauth.Auth) error { return nil }
...
func (e *CodexExecutor) CountTokens(ctx context.Context, auth *switchailocalauth.Auth, req switchailocalexecutor.Request, opts switchailocalexecutor.Options) (switchailocalexecutor.Response, error) {
	...
	if err != nil {
		return switchailocalexecutor.Response{}, fmt.Errorf("codex executor: tokenizer init failed: %w", err)
	}

	count, err := countCodexInputTokens(enc, body)
	if err != nil {
		return switchailocalexecutor.Response{}, fmt.Errorf("codex executor: token counting failed: %w", err)
	}
...
func (e *CodexExecutor) cacheHelper(ctx context.Context, from sdktranslator.Format, url string, req switchailocalexecutor.Request, rawJSON []byte) (*http.Request, error) {
...
func applyCodexHeaders(r *http.Request, auth *switchailocalauth.Auth, token string) {
...
func codexCreds(a *switchailocalauth.Auth) (apiKey, baseURL string) {
	if a == nil {
		return "", ""
	}
	if a.Attributes != nil {

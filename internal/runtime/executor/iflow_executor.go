...
func (e *IFlowExecutor) PrepareRequest(_ *http.Request, _ *switchailocalauth.Auth) error { return nil }
...
func (e *IFlowExecutor) CountTokens(ctx context.Context, auth *switchailocalauth.Auth, req switchailocalexecutor.Request, opts switchailocalexecutor.Options) (switchailocalexecutor.Response, error) {
	...
	if err != nil {
		return switchailocalexecutor.Response{}, fmt.Errorf("iflow executor: tokenizer init failed: %w", err)
	}

	count, err := countOpenAIChatTokens(enc, body)
	if err != nil {
		return switchailocalexecutor.Response{}, fmt.Errorf("iflow executor: token counting failed: %w", err)
	}
...
func (e *IFlowExecutor) refreshCookieBased(ctx context.Context, auth *switchailocalauth.Auth, cookie, email string) (*switchailocalauth.Auth, error) {
...
func (e *IFlowExecutor) refreshOAuthBased(ctx context.Context, auth *switchailocalauth.Auth) (*switchailocalauth.Auth, error) {
	refreshToken := ""
	oldAccessToken := ""
	if auth.Metadata != nil {
...
func iflowCreds(a *switchailocalauth.Auth) (apiKey, baseURL string) {
	if a == nil {
		return "", ""
	}
	if a.Attributes != nil {

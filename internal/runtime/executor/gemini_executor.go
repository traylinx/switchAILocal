...
func (e *GeminiExecutor) PrepareRequest(_ *http.Request, _ *switchailocalauth.Auth) error { return nil }
...
func (e *GeminiExecutor) CountTokens(ctx context.Context, auth *switchailocalauth.Auth, req switchailocalexecutor.Request, opts switchailocalexecutor.Options) (switchailocalexecutor.Response, error) {
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		return switchailocalexecutor.Response{}, statusErr{code: resp.StatusCode, msg: string(data)}
	}
...
func geminiCreds(a *switchailocalauth.Auth) (apiKey, bearer string) {
	if a == nil {
		return "", ""
	}
	if a.Attributes != nil {
...
func resolveGeminiBaseURL(auth *switchailocalauth.Auth) string {
	base := glEndpoint
...
func applyGeminiHeaders(req *http.Request, auth *switchailocalauth.Auth) {

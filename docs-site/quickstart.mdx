...
Get switchAILocal up and running with your first AI request in minutes.

## What You'll Build

By the end of this guide, you'll have:
- switchAILocal server running at `http://localhost:18080`
- At least one AI provider connected
- Made your first successful AI request
...
<Note>
  **Using npx?** It downloads the right binary for your system automatically — no Go, no Docker, no build step needed.
</Note>

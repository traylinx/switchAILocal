...
## 2026-05-31 - Optimize SSE emitEvent hot paths
**Learning:** Using `fmt.Sprintf` in SSE event generation hot paths introduces unnecessary reflection overhead and allocations (176 B/op, 1 alloc/op vs 0 B/op).
